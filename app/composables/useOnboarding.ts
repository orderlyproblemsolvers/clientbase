  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        type: "textarea",
        label: "Brand Story",
        placeholder: "How did the business start?",
        required: true,
        options: [],
        position: 2,
        maxFiles: 1,
      ...
      },
      {
        type: "textarea",
        label: "Target Audience",
        placeholder: "Age, interests, location…",
        required: true,
        options: [],
        position: 3,
        maxFiles: 1,
      ...
      },
      {
        ...
        placeholder: "Any colours you love or hate?",
        required: false,
        options: [],
        position: 5,
        maxFiles: 1,
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: "Describe the app or system",
        required: true,
        options: [],
        position: 2,
        maxFiles: 1,
      ...
      },
      {
        ...
        placeholder: "List the core features",
        required: true,
        options: [],
        position: 3,
        maxFiles: 1,
      ...
      },
      {
        ...
        placeholder: "e.g. Paystack, WhatsApp API",
        required: false,
        options: [],
        position: 4,
        maxFiles: 1,
      ...
      },
      {
        ...
        placeholder: "",
        required: false,
        options: ["Web App", "Mobile App", "Both", "API only"],
        position: 5,
        maxFiles: 1,
        acceptedTypes: [],
      },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: "What ongoing support do you need?",
        required: true,
        options: [],
        position: 3,
        maxFiles: 1,
      ...
      },
      {
        ...
        placeholder: "What should be delivered each month?",
        required: true,
        options: [],
        position: 4,
        maxFiles: 1,
